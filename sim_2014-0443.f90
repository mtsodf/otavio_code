...
open(100, FILE ='coeff_excl_sim.txt')
open(101, FILE ='coeff_EV_sim.txt')
open(102, FILE ='coeff_q_sim.txt')
!open(103, FILE ='coeff_blimit_sim.txt')
do i_access = 1,access_num
   do i_y = 1,y_num_finer
       do i_b_short = 1,b_num_short_finer
...
do i_b_short = 1,b_num_short
     do i_b_long = 1,b_num_long
         ...
         READ(20, '(F20.10, X, F20.10, X, F20.10)') v_matrix(i_b_short, i_b_long, i_y, i_access), &
